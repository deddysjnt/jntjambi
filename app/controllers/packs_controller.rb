class PacksController < ApplicationController
  ...
  private
    ...
    def pack_params
      params.require(:pack).permit(:droppoint_id, :tanggal, :manifest_id, :tujuan, :agent_tujuan, :droppoint_tujuan, :nomor_bagging, :kg_fisik, :awb_fisik, :team_kerja, :team_shift, :description, :tanggal_approve, :user_approve, :user_add, :user_edit, :ip_address, :flag)
    end
end
